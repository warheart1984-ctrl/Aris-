...
from .profiles import aris_runtime_profiles
...
class ULDesktopRuntimeBootstrap:
    ...
    def build_manifest(self) -> ULDesktopRuntimeManifest:
        ...
        profiles = aris_runtime_profiles()
        canonical_payload = {
            ...
            "pyinstaller_artifact": "ARIS V2.exe" if sys.platform.startswith("win") else "ARIS V2",
    ...
    def runtime_commands(self) -> dict[str, Any]:
        ...
        return {
            ...
            "run_desktop": [runtime_python, "-m", "evolving_ai.aris_runtime.desktop"],
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Build and verify the UL-bound PySide6 desktop runtime for ARIS V2.")
