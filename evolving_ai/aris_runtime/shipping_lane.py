...
REQUIRED_REPO_ASSETS = (
    "pyproject.toml",
    "evolving_ai/aris_runtime/desktop.py",
    "evolving_ai/aris_runtime/desktop_app.py",
    "evolving_ai/aris_runtime/desktop_build.py",
    "evolving_ai/aris_runtime/desktop_support.py",
    "evolving_ai/aris_runtime/profiles.py",
)
        ...
        required_items.append(
            {
                ...
                "path": str((resolved_repo_root / "evolving_ai" / "aris_runtime" / profile.entry_script).resolve()),
            }
        )
