...
from evolving_ai.aris_runtime.desktop_runtime import ULDesktopRuntimeBootstrap, default_runtime_root


REPO_ROOT = Path(__file__).resolve().parents[1]
TEST_RUNTIME_ROOT = REPO_ROOT / ".runtime" / "aris-runtime-desktop-runtime-test"
...
class ArisRuntimeDesktopRuntimeTests(unittest.TestCase):
    ...
    def test_manifest_is_bound_to_ul_runtime(self) -> None:
        ...
        self.assertEqual(manifest.runtime_name, "ARIS V2 UL Desktop Runtime")
        ...
        self.assertEqual(manifest.profile_ids, ("v2",))
        self.assertIn("ARIS V2", manifest.profile_artifacts)
    ...
    def test_plan_payload_emits_prepare_and_run_commands(self) -> None:
        ...
        self.assertEqual(commands["run_desktop"][-2:], ["-m", "evolving_ai.aris_runtime.desktop"])
